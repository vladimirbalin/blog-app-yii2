...
use yii\helpers\StringHelper; ?>
    ...
    <div class="card card-body ">
        ...
        <div class="bg-light p-2 mb-2 fs-6 fw-lighter">posted by: <span class="fw-bolder"><strong><?= $user ?></strong></span>
            on <?= Yii::$app->formatter->asDatetime($model->created_at, 'php:Y-m-d H:i:s') ?></div>
